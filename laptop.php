...
<head>
    ...
    <title>LaptopArena | Laptop</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <?php
                $sql = "SELECT * FROM laptop_category WHERE Laptop_category='Dell Laptop'";
        ...
        <div class="seeAll">
            ...
            <button type="button" class="btn btn-outline-primary btn-sm btnSeeAll" id="Lenovo Laptop">See All</button>
        </div>
        
        <hr>
        <div class="row">
        <?php
            $sql = "SELECT * FROM laptop_category WHERE Laptop_category='Lenovo Laptop'";
            $result = $conn->query($sql);
            if ($result->num_rows > 0) {
            $count=0;
            while(($row = $result->fetch_assoc()) && $count<4) {
        ...
        <div class="seeAll">
            ...
            <button type="button" class="btn btn-outline-primary btn-sm btnSeeAll" id="Hp Laptop">See All</button>
        </div>
        
        <hr>
        <div class="row">
        <?php
            $sql = "SELECT * FROM laptop_category WHERE Laptop_category='Hp Laptop'";
            $result = $conn->query($sql);
            if ($result->num_rows > 0) {
            $count=0;
            while(($row = $result->fetch_assoc()) && $count<4) {
